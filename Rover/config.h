...
#ifndef ROVER_MODE_ACRO_ENABLED
# define ROVER_MODE_ACRO_ENABLED 1
#endif

//////////////////////////////////////////////////////////////////////////////
// Auto mode - waypoint-following mode
#ifndef ROVER_MODE_AUTO_ENABLED
# define ROVER_MODE_AUTO_ENABLED AP_MISSION_ENABLED
#endif

//////////////////////////////////////////////////////////////////////////////
// Circle mode - circle around specifc location
#ifndef ROVER_MODE_CIRCLE_ENABLED
# define ROVER_MODE_CIRCLE_ENABLED 1
#endif

//////////////////////////////////////////////////////////////////////////////
// Dock mode - allows vehicle to dock to a docking target
#ifndef ROVER_MODE_DOCK_ENABLED
# define ROVER_MODE_DOCK_ENABLED AC_PRECLAND_ENABLED
#endif

//////////////////////////////////////////////////////////////////////////////
// Follow mode - allows vehicle to follow target
#ifndef ROVER_MODE_FOLLOW_ENABLED
# define ROVER_MODE_FOLLOW_ENABLED AP_FOLLOW_ENABLED
#endif

//////////////////////////////////////////////////////////////////////////////
// Guided mode - offboard waypoint or attitude control
#ifndef ROVER_MODE_GUIDED_ENABLED
# define ROVER_MODE_GUIDED_ENABLED 1
#endif

//////////////////////////////////////////////////////////////////////////////
// Hold mode - stop vehicle moving under its own power (BalanceBot keeps balancing)
#ifndef ROVER_MODE_HOLD_ENABLED
# define ROVER_MODE_HOLD_ENABLED 1
#endif
...
#ifndef ROVER_MODE_LOITER_ENABLED
# define ROVER_MODE_LOITER_ENABLED 1
#endif

//////////////////////////////////////////////////////////////////////////////
// Manual mode - basic pass-through control of inputs to mixed outputs
#ifndef ROVER_MODE_MANUAL_ENABLED
# define ROVER_MODE_MANUAL_ENABLED 1
#endif

//////////////////////////////////////////////////////////////////////////////
// RTL mode - vehicle travels towards home (or rally items)
#ifndef ROVER_MODE_RTL_ENABLED
# define ROVER_MODE_RTL_ENABLED 1
#endif

//////////////////////////////////////////////////////////////////////////////
// Simple mode - vehicle is controlled via earth-frame rather than body frame RC input
#ifndef ROVER_MODE_SIMPLE_ENABLED
# define ROVER_MODE_SIMPLE_ENABLED 1
#endif

//////////////////////////////////////////////////////////////////////////////
// SmartRTL mode - vehicle retraces its path to home
#ifndef ROVER_MODE_SMARTRTL_ENABLED
# define ROVER_MODE_SMARTRTL_ENABLED 1
#endif

//////////////////////////////////////////////////////////////////////////////
// Steering mode - basic driving mode based on desired lateral acceleration
#ifndef ROVER_MODE_STEERING_ENABLED
# define ROVER_MODE_STEERING_ENABLED 1
#endif
