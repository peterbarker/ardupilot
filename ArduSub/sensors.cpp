...
void Sub::read_rangefinder()
{
    ...
    float temp_alt = rangefinder.distance_orient(ROTATION_PITCH_270);
    ...
    rangefinder_state.alt = temp_alt;
    ...
    rangefinder_state.max = rangefinder.max_distance_orient(ROTATION_PITCH_270) * 100;
