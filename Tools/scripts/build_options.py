...
BUILD_OPTIONS = [
    ...
    Feature('Sensors', 'TEMPCAL_LIB', 'AP_TEMPCALIBRATION_ENABLED', 'Enable temperature calibration library', 0, None),
    ...
    Feature('Airspeed Drivers', 'SDP3X', 'AP_AIRSPEED_SDP3X_ENABLED', 'Enable SDP3X AIRSPEED', 0, 'AIRSPEED,BARO'),
