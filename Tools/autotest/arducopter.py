...
# 10m delta        low_position = mavutil.location(-35.358273, 149.169165, current_alt, 0)
    ...
    def fly_beacon_position(self):
        ...
        try:
            ...
            self.set_parameter("EK3_SRC1_POSZ", 4)  # Beacon
            self.set_parameter("EK3_SRC1_VELXY", 0) # None
            self.set_parameter("EK3_SRC1_VELZ", 0)  # None
            self.set_parameter("EK3_SRC2_POSXY", 4) # Beacon
            self.set_parameter("EK3_SRC2_POSZ", 4)  # Beacon
            self.set_parameter("EK3_SRC2_VELXY", 0) # None
            self.set_parameter("EK3_SRC2_VELZ", 0)  # None
            self.set_parameter("EK2_ENABLE", 0)
            self.reboot_sitl()
