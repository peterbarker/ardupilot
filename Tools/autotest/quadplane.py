...
class AutoTestQuadPlane(vehicle_test_suite.TestSuite):
    ...
    def BVLOSMissionRTLFuzz(self):
        ...
        self.context_set_message_rate_hz('ESC_TELEMETRY_5_TO_8', -1)
        self.context_set_message_rate_hz('ESC_TELEMETRY_1_TO_4', -1)
        self.context_set_message_rate_hz('RC_CHANNELS', -1)
        self.context_set_message_rate_hz('RAW_IMU', -1)
        self.context_set_message_rate_hz('AHRS', -1)
        self.context_set_message_rate_hz('SCALED_IMU2', -1)
        self.context_set_message_rate_hz('AHRS2', -1)
        self.context_set_message_rate_hz('VIBRATION', -1)
        self.context_set_message_rate_hz('LOCAL_POSITION_NED', -1)
        self.context_set_message_rate_hz('SCALED_PRESSURE2', -1)
        self.context_set_message_rate_hz('SCALED_PRESSURE', -1)
        self.context_set_message_rate_hz('MEMINFO', -1)
        self.context_set_message_rate_hz('AOA_SSA', -1)
        self.context_set_message_rate_hz('SCALED_IMU2', -1)
        self.context_set_message_rate_hz('SCALED_IMU3', -1)
        self.context_set_message_rate_hz('POWER_STATUS', -1)
        self.context_set_message_rate_hz('POWER_STATUS', -1)
        self.context_set_message_rate_hz('SIMSTATE', -1)
        self.context_set_message_rate_hz('GPS_RAW_INT', -1)
        self.context_set_message_rate_hz('SERVO_OUTPUT_RAW', -1)

        self.context_set_message_rate_hz('EKF_STATUS_REPORT', 0.2)

        slow_rate = 1
        self.context_set_message_rate_hz('POSITION_TARGET_GLOBAL_INT', slow_rate)
        self.context_set_message_rate_hz('SYS_STATUS', slow_rate)
        self.context_set_message_rate_hz('ATTITUDE', slow_rate)
        self.context_set_message_rate_hz('NAV_CONTROLLER_OUTPUT', slow_rate)
