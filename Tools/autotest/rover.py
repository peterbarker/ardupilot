...
#        oldalt = downloaded_items[changealt_item].z
    ...
    def SIMCompare(self):
        ...
        self.wait_ready_to_arm()
        self.arm_vehicle()
        self.drive_to_location(self.home_relative_loc_ne(40, 0), timeout=60)
        self.drive_to_location(self.home_relative_loc_ne(40, 40), timeout=60)
        self.drive_to_location(self.home_relative_loc_ne(0, 0), timeout=60)
        self.disarm_vehicle()
