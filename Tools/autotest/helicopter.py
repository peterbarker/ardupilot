...
class AutoTestHelicopter(AutoTestCopter):
    ...
    def GovernorNotEngagedManualThrottle(self):
        ...
        self.change_mode('STABILIZE')
        self.wait_statustext("Runup Complete", check_context=True, timeout=30)
        ...
        self.set_message_rate_hz(id=mavutil.mavlink.MAVLINK_MSG_ID_EXTENDED_SYS_STATE, rate_hz=0)
