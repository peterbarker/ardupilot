...
class sitl_periph_gps(sitl):
    def configure_env(self, cfg, env):
        ...
        env.DEFINES.update(
            ...
            HAL_EXTERNAL_AHRS_ENABLED = 1,
            AP_EXTERNAL_AHRS_BACKEND_DEFAULT_ENABLED = 0,
            HAL_PERIPH_ENABLE_EXTERNAL_AHRS = 1,
            HAL_EXTERNAL_AHRS_DEFAULT = 17,  # DroneCANSensors
            AP_EXTERNAL_AHRS_DRONECAN_SENSOR_INJECTION_ENABLED = 1,
