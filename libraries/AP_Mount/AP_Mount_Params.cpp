...
const AP_Param::GroupInfo AP_Mount_Params::var_info[] = {
    ...
    // @Values: 0:None, 1:Servo, 2:3DR Solo, 3:Alexmos Serial, 4:SToRM32 MAVLink, 5:SToRM32 Serial, 6:MAVLink (Gremsy/AVT), 7:BrushlessPWM, 8:Siyi, 9:Scripting, 10:Xacti, 11:Viewpro, 12:Topotek, 13:CADDX, 14:XFRobot, 15:GimbalAI
    // @RebootRequired: True
    // @User: Standard
