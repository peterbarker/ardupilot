...
public:
    ...
    /// return system time of last update to the inclusion circles
    ...
    // returns true if a polygonal include fence could be returned.
    // May attempt to load the points from the eeprom
    ...
    bool loaded() const WARN_IF_UNUSED { return _loaded_offsets_from_origin != nullptr; };
