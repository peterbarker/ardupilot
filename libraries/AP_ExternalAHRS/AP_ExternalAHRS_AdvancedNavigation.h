...
#ifndef HAL_EXTERNAL_AHRS_ADNAV_ENABLED
#define HAL_EXTERNAL_AHRS_ADNAV_ENABLED HAL_EXTERNAL_AHRS_ENABLED
#endif

#if HAL_EXTERNAL_AHRS_ADNAV_ENABLED
...
private:
    ...
    struct PACKED AN_SYSTEM_STATE {
        ...
        float velocity_e;
        float velocity_d;
        float body_acceleration_x; // m/s/s
        ...
        float lat_standard_deviation; //m
        float long_standard_deviation;
