...
private:
    ...
    static const uint8_t hwid_a { '7' };
    static const uint8_t hwid_b { 'A' };

    static const uint8_t camera_major { 1 };
    static const uint8_t camera_minor { 2 };
    static const uint8_t camera_patch { 3 };

    static const uint8_t gimbal_major { 4 };
    static const uint8_t gimbal_minor { 5 };
    static const uint8_t gimbal_patch { 6 };

    static const uint8_t zoom_major { 7 };
    static const uint8_t zoom_minor { 8 };
    static const uint8_t zoom_patch { 9 };
