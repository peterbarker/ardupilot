...
#if AP_SIM_FRAME_COPTER_HEXACONTATETRA_OCTAQUAD_X_ENABLED
static Motor hexacontatetra_octaquad_x_motors[] =
{
    Motor(AP_MOTORS_MOT_1,   45, AP_MOTORS_MATRIX_YAW_FACTOR_CCW,   1),
    Motor(AP_MOTORS_MOT_2, -135, AP_MOTORS_MATRIX_YAW_FACTOR_CCW,  33),
    Motor(AP_MOTORS_MOT_3,  -45, AP_MOTORS_MATRIX_YAW_FACTOR_CW,   49),
    Motor(AP_MOTORS_MOT_4,  135, AP_MOTORS_MATRIX_YAW_FACTOR_CW,   17),

    Motor(AP_MOTORS_MOT_5,   45, AP_MOTORS_MATRIX_YAW_FACTOR_CW,    2),
    Motor(AP_MOTORS_MOT_6, -135, AP_MOTORS_MATRIX_YAW_FACTOR_CW,   34),
    Motor(AP_MOTORS_MOT_7,  -45, AP_MOTORS_MATRIX_YAW_FACTOR_CCW,  50),
    Motor(AP_MOTORS_MOT_8,  135, AP_MOTORS_MATRIX_YAW_FACTOR_CCW,  18),

    Motor(AP_MOTORS_MOT_9,   45, AP_MOTORS_MATRIX_YAW_FACTOR_CCW,   3),
    Motor(AP_MOTORS_MOT_10, -135, AP_MOTORS_MATRIX_YAW_FACTOR_CCW, 35),
    Motor(AP_MOTORS_MOT_11,  -45, AP_MOTORS_MATRIX_YAW_FACTOR_CW,  51),
    Motor(AP_MOTORS_MOT_12,  135, AP_MOTORS_MATRIX_YAW_FACTOR_CW,  19),

    Motor(AP_MOTORS_MOT_13,   45, AP_MOTORS_MATRIX_YAW_FACTOR_CW,   4),
    Motor(AP_MOTORS_MOT_14, -135, AP_MOTORS_MATRIX_YAW_FACTOR_CW,  36),
    Motor(AP_MOTORS_MOT_15,  -45, AP_MOTORS_MATRIX_YAW_FACTOR_CCW, 52),
    Motor(AP_MOTORS_MOT_16,  135, AP_MOTORS_MATRIX_YAW_FACTOR_CCW, 20),

    Motor(AP_MOTORS_MOT_17,   45, AP_MOTORS_MATRIX_YAW_FACTOR_CCW,   5),
    Motor(AP_MOTORS_MOT_18, -135, AP_MOTORS_MATRIX_YAW_FACTOR_CCW,  37),
    Motor(AP_MOTORS_MOT_19,  -45, AP_MOTORS_MATRIX_YAW_FACTOR_CW,  53),
    Motor(AP_MOTORS_MOT_20,  135, AP_MOTORS_MATRIX_YAW_FACTOR_CW,  21),

    Motor(AP_MOTORS_MOT_21,   45, AP_MOTORS_MATRIX_YAW_FACTOR_CW,    6),
    Motor(AP_MOTORS_MOT_22, -135, AP_MOTORS_MATRIX_YAW_FACTOR_CW,   38),
    Motor(AP_MOTORS_MOT_23,  -45, AP_MOTORS_MATRIX_YAW_FACTOR_CCW,  54),
    Motor(AP_MOTORS_MOT_24,  135, AP_MOTORS_MATRIX_YAW_FACTOR_CCW,  22),

    Motor(AP_MOTORS_MOT_25,   45, AP_MOTORS_MATRIX_YAW_FACTOR_CCW,   7),
    Motor(AP_MOTORS_MOT_26, -135, AP_MOTORS_MATRIX_YAW_FACTOR_CCW,  39),
    Motor(AP_MOTORS_MOT_27,  -45, AP_MOTORS_MATRIX_YAW_FACTOR_CW,  55),
    Motor(AP_MOTORS_MOT_28,  135, AP_MOTORS_MATRIX_YAW_FACTOR_CW,  23),

    Motor(AP_MOTORS_MOT_29,   45, AP_MOTORS_MATRIX_YAW_FACTOR_CW,    8),
    Motor(AP_MOTORS_MOT_30, -135, AP_MOTORS_MATRIX_YAW_FACTOR_CW,   40),
    Motor(AP_MOTORS_MOT_31,  -45, AP_MOTORS_MATRIX_YAW_FACTOR_CCW,  56),
    Motor(AP_MOTORS_MOT_32,  135, AP_MOTORS_MATRIX_YAW_FACTOR_CCW,  24),

    Motor(AP_MOTORS_MOT_33,   45, AP_MOTORS_MATRIX_YAW_FACTOR_CCW,   9),
    Motor(AP_MOTORS_MOT_34, -135, AP_MOTORS_MATRIX_YAW_FACTOR_CCW,  41),
    Motor(AP_MOTORS_MOT_35,  -45, AP_MOTORS_MATRIX_YAW_FACTOR_CW,  57),
    Motor(AP_MOTORS_MOT_36,  135, AP_MOTORS_MATRIX_YAW_FACTOR_CW,  25),

    Motor(AP_MOTORS_MOT_37,   45, AP_MOTORS_MATRIX_YAW_FACTOR_CW,   10),
    Motor(AP_MOTORS_MOT_38, -135, AP_MOTORS_MATRIX_YAW_FACTOR_CW,  42),
    Motor(AP_MOTORS_MOT_39,  -45, AP_MOTORS_MATRIX_YAW_FACTOR_CCW, 58),
    Motor(AP_MOTORS_MOT_40,  135, AP_MOTORS_MATRIX_YAW_FACTOR_CCW, 26),

    Motor(AP_MOTORS_MOT_41,   45, AP_MOTORS_MATRIX_YAW_FACTOR_CCW,  11),
    Motor(AP_MOTORS_MOT_42, -135, AP_MOTORS_MATRIX_YAW_FACTOR_CCW, 43),
    Motor(AP_MOTORS_MOT_43,  -45, AP_MOTORS_MATRIX_YAW_FACTOR_CW,  59),
    Motor(AP_MOTORS_MOT_44,  135, AP_MOTORS_MATRIX_YAW_FACTOR_CW,  27),

    Motor(AP_MOTORS_MOT_45,   45, AP_MOTORS_MATRIX_YAW_FACTOR_CW,   12),
    Motor(AP_MOTORS_MOT_46, -135, AP_MOTORS_MATRIX_YAW_FACTOR_CW,  44),
    Motor(AP_MOTORS_MOT_47,  -45, AP_MOTORS_MATRIX_YAW_FACTOR_CCW, 60),
    Motor(AP_MOTORS_MOT_48,  135, AP_MOTORS_MATRIX_YAW_FACTOR_CCW, 28),

    Motor(AP_MOTORS_MOT_49,   45, AP_MOTORS_MATRIX_YAW_FACTOR_CCW,  13),
    Motor(AP_MOTORS_MOT_50, -135, AP_MOTORS_MATRIX_YAW_FACTOR_CCW, 45),
    Motor(AP_MOTORS_MOT_51,  -45, AP_MOTORS_MATRIX_YAW_FACTOR_CW,  61),
    Motor(AP_MOTORS_MOT_52,  135, AP_MOTORS_MATRIX_YAW_FACTOR_CW,  29),

    Motor(AP_MOTORS_MOT_53,   45, AP_MOTORS_MATRIX_YAW_FACTOR_CW,   14),
    Motor(AP_MOTORS_MOT_54, -135, AP_MOTORS_MATRIX_YAW_FACTOR_CW,  46),
    Motor(AP_MOTORS_MOT_55,  -45, AP_MOTORS_MATRIX_YAW_FACTOR_CCW, 62),
    Motor(AP_MOTORS_MOT_56,  135, AP_MOTORS_MATRIX_YAW_FACTOR_CCW, 30),

    Motor(AP_MOTORS_MOT_57,   45, AP_MOTORS_MATRIX_YAW_FACTOR_CCW,  15),
    Motor(AP_MOTORS_MOT_58, -135, AP_MOTORS_MATRIX_YAW_FACTOR_CCW, 47),
    Motor(AP_MOTORS_MOT_59,  -45, AP_MOTORS_MATRIX_YAW_FACTOR_CW,  63),
    Motor(AP_MOTORS_MOT_60,  135, AP_MOTORS_MATRIX_YAW_FACTOR_CW,  31),

    Motor(AP_MOTORS_MOT_61,   45, AP_MOTORS_MATRIX_YAW_FACTOR_CW,   16),
    Motor(AP_MOTORS_MOT_62, -135, AP_MOTORS_MATRIX_YAW_FACTOR_CW,  48),
    Motor(AP_MOTORS_MOT_63,  -45, AP_MOTORS_MATRIX_YAW_FACTOR_CCW, 64),
    Motor(AP_MOTORS_MOT_64,  135, AP_MOTORS_MATRIX_YAW_FACTOR_CCW, 32),
};
...
#endif  // AP_SIM_FRAME_COPTER_DOTRIACONTA_OCTAQUAD_X_ENABLED
#if AP_SIM_FRAME_COPTER_HEXACONTATETRA_OCTAQUAD_X_ENABLED
    Frame("hexacontatetra", 32, hexacontatetra_octaquad_x_motors),
#endif  // AP_SIM_FRAME_COPTER_DOTRIACONTA_OCTAQUAD_X_ENABLED
