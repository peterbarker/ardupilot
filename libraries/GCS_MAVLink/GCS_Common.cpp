...
void GCS_MAVLINK::send_distance_sensor(const AP_RangeFinder_Backend *sensor, const uint8_t instance) const
{
    ...
    mavlink_msg_distance_sensor_send(
        ...
        sensor->min_distance() * 100,               // minimum distance the sensor can measure in centimeters
        sensor->max_distance() * 100,               // maximum distance the sensor can measure in centimeters
        sensor->distance() * 100,                   // current distance reading
