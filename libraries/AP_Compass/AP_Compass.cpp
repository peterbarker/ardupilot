...
void Compass::probe_i2c_dev(DriverType driver_type, AP_Compass_Backend* (*probefn)(AP_HAL::OwnPtr<AP_HAL::Device>, Rotation), uint8_t i2c_bus, uint8_t i2c_addr, Rotation rotation)
{
    if (!_driver_enabled(driver_type)) {
        return;
    }
