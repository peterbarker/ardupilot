...
#ifndef AP_AHRS_CINS_ENABLED
#define AP_AHRS_CINS_ENABLED AP_AHRS_BACKEND_DEFAULT_ENABLED && AP_INERTIALSENSOR_ENABLED && (CONFIG_HAL_BOARD == HAL_BOARD_SITL)
#endif

#undef AP_AHRS_CINS_ENABLED
#define AP_AHRS_CINS_ENABLED AP_AHRS_BACKEND_DEFAULT_ENABLED && AP_INERTIALSENSOR_ENABLED
