...
void AP_AHRS::update(bool skip_ins_update)
{
    ...
    if (state.active_EKF_type != last_active_ekf_type) {
        ...
        active_backend = backend_for_type(state.active_EKF_type);
...
#if HAL_NAVEKF2_AVAILABLE
    case EKFType::TWO:
        return ekf2.wind_estimate(wind);
#endif
...
#if HAL_NAVEKF3_AVAILABLE
    case EKFType::THREE:
        return ekf3.EKF3.getAirSpdHealthData(innovation, innovationVariance, age_ms);
#endif
...
bool AP_AHRS::_get_quaternion(Quaternion &quat) const
{
    ...
    case EKFType::TWO:
        ...
        UNUSED_RESULT(ekf2.get_quaternion(quat));
        break;
#endif
#if HAL_NAVEKF3_AVAILABLE
    case EKFType::THREE:
        ...
        UNUSED_RESULT(ekf3.get_quaternion(quat));
        break;
#endif
#if AP_AHRS_SIM_ENABLED
    case EKFType::SIM:
...
#if HAL_NAVEKF2_AVAILABLE
    case EKFType::TWO:
        ekf2.EKF2.getVelNED(vec);
        return true;
#endif

#if HAL_NAVEKF3_AVAILABLE
    case EKFType::THREE:
        ekf3.EKF3.getVelNED(vec);
        return true;
#endif
...
#if HAL_NAVEKF2_AVAILABLE
    case EKFType::TWO:
        return ekf2.get_vert_pos_rate_D(velocity);
#endif

#if HAL_NAVEKF3_AVAILABLE
    case EKFType::THREE:
        return ekf3.get_vert_pos_rate_D(velocity);
#endif
...
#if HAL_NAVEKF2_AVAILABLE
    case EKFType::TWO:
        return ekf2.EKF2.getHAGL(height);
#endif

#if HAL_NAVEKF3_AVAILABLE
    case EKFType::THREE:
        return ekf3.EKF3.getHAGL(height);
#endif
...
#if HAL_NAVEKF2_AVAILABLE
    case EKFType::TWO:
        ekf2.get_control_limits(ekfGndSpdLimit,ekfNavVelGainScaler);
        break;
#endif

#if HAL_NAVEKF3_AVAILABLE
    case EKFType::THREE:
        ekf3.get_control_limits(ekfGndSpdLimit,ekfNavVelGainScaler);
        break;
#endif
...
void AP_AHRS::_getCorrectedDeltaVelocityNED(Vector3f& ret, float& dt) const
{
    ...
    case EKFType::TWO:
        ...
        ekf2.EKF2.getAccelZBias(accel_bias.z);
        break;
#endif
#if HAL_NAVEKF3_AVAILABLE
    case EKFType::THREE:
        imu_idx = ekf3.EKF3.getPrimaryCoreIMUIndex();
        ekf3.EKF3.getAccelBias(-1,accel_bias);
        break;
#endif
#if AP_AHRS_SIM_ENABLED
    case EKFType::SIM:
...
#if HAL_NAVEKF2_AVAILABLE
    case EKFType::TWO:
        ekf2.EKF2.checkLaneSwitch();
        break;
#endif

#if HAL_NAVEKF3_AVAILABLE
    case EKFType::THREE:
        ekf3.EKF3.checkLaneSwitch();
        break;
#endif
    }
}
