...
#define AP_FILESYSTEM_SYS_FLASH_ENABLED (CONFIG_HAL_BOARD == HAL_BOARD_CHIBIOS || CONFIG_HAL_BOARD == HAL_BOARD_SITL)
#endif

#ifndef AP_LUA_SHA256_BINDING_ENABLED
#define AP_LUA_SHA256_BINDING_ENABLED 0
#endif
