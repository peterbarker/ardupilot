...
function info(rotation)
  ...
  gcs:send_text(0, string.format("Rotation %d %.0f range %d - %d offset %.0f %.0f %.0f ground clearance %.0f", rotation, distance, distance_min, distance_max, offset:x(), offset:y(), offset:z(), ground_clearance))
end
