...
const AP_Param::GroupInfo AP_BattMonitor_Params::var_info[] = {
    ...
    // @Values{Copter}: 0:None,1:Land,2:RTL,3:SmartRTL or RTL,4:SmartRTL or Land,5:Terminate,6:Auto DO_LAND_START or RTL,7:Enabled always Brake or Land,8:Ship Ops
